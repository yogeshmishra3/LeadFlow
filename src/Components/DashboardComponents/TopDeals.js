...
const TopDeals = () => {
    ...
    useEffect(() => {
        const fetchTopDeals = async () => {
            try {
                const response = await axios.get('https://crm-mu-sooty.vercel.app/api/dealmanagement'); // Update with your deployed backend URL
        ...
        const fetchDealsStats = async () => {
            try {
                ...
                const dealsResponse = await axios.get('https://crm-mu-sooty.vercel.app/api/dealmanagement'); // Replace with your backend URL
                ...
                const quotationsResponse = await axios.get('https://crm-mu-sooty.vercel.app/api/newquotations'); // Replace with your quotations API URL
        ...
        const fetchSavedQuotations = async () => {
            try {
                const response = await axios.get('https://crm-mu-sooty.vercel.app/api/newquotations'); // Replace with your quotations API URL
